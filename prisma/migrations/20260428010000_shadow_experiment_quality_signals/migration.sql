...
ALTER TABLE "model_experiments"
  ...
  ADD COLUMN IF NOT EXISTS "thumbsUpA"      INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS "thumbsUpB"      INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS "thumbsDownA"    INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS "thumbsDownB"    INTEGER NOT NULL DEFAULT 0;
