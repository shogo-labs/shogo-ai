...
const metrics = {"queued":"0","inflight":"0","connected":"0","demoBooked":"0"};
const calls = [];
const activeCallId = null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold tracking-tight", children: "Outbound Calls" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Twilio + ElevenLabs cold-call agent. Disclose AI, qualify, book demos." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: "Connect Twilio + ElevenLabs to start" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Queued", value: data.metrics.queued }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "In flight", value: data.metrics.inflight }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Connected", value: data.metrics.connected }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Demos booked", value: data.metrics.demoBooked })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Call Queue" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: calls.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: 'No calls queued. Import leads from the BDR Pipeline or paste a list, then say "start calling" to dial.' }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: calls.map((c, i) => {
            const status = c.status ?? "queued";
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium", children: c.name ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: c.company ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: c.phone ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: STATUS_VARIANT[status], children: STATUS_LABEL[status] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "max-w-[260px] truncate", children: c.qualificationNotes ?? c.disposition ?? "—" })
            ] }, c.id ?? i);
          }) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Live Transcript" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          activeCall ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium", children: [
              activeCall.name ?? "Prospect",
              " — ",
              activeCall.company ?? ""
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "w-fit", children: STATUS_LABEL[activeCall.status ?? "connected"] })
          ] }) : null,
          /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-[320px] pr-3", children: transcript.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No active call. The transcript will stream here when a call connects." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: transcript.map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] uppercase tracking-wide text-muted-foreground", children: [
              line.speaker ?? "agent",
              " ",
              line.ts ? `· ${line.ts}` : ""
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: line.text })
          ] }, i)) }) })
        ] })
      ] })
    ] })
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(OutboundCalls, {}) });
}
