...
function Tooltip({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative inline-flex", children });
}
function TooltipTrigger({ children, className, ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className, ...props, children });
}
...
const metrics = {"leads":"0","enriched":"0","drafted":"0","queued":"0"};
const leads = [];
const initialData = {
  metrics,
  leads,
...
function BDRPipeline() {
  const [data] = reactExports.useState(initialData);
  const leads = data.leads ?? [];
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold tracking-tight", children: "BDR Pipeline" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Researched accounts, enriched leads, and queued Gmail drafts." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: "Connect Gmail to queue drafts" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Leads", value: data.metrics.leads }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Enriched", value: data.metrics.enriched }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Drafted", value: data.metrics.drafted }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Drafts Queued", value: data.metrics.queued })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Pipeline" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: leads.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-2 py-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: `No leads yet. Tell me your ICP — for example, "Pull 50 Series A SaaS founders in NY who raised in the last 6 months" — and I'll research, enrich, draft personalized openers, and queue Gmail drafts for your review.` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Hover any row once populated to see the full personalized opener." })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Signal" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Draft" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: leads.map((lead, i) => {
          const status = lead.draftStatus ?? "none";
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "cursor-default", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium", children: lead.name ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: lead.role ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: lead.company ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: lead.stage ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: lead.location ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "max-w-[260px] truncate", children: lead.recentSignal ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: STATUS_VARIANT[status] ?? "outline", children: status }) })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { className: "max-w-md whitespace-pre-wrap text-sm", children: lead.opener ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: lead.opener }),
              lead.signalSource && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                "Source: ",
                lead.signalSource
              ] })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No personalized opener drafted yet." }) })
          ] }, lead.id ?? i);
        }) })
      ] }) })
    ] })
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BDRPipeline, {}) });
}
