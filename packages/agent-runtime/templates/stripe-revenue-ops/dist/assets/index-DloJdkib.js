...
const TableRow = reactExports.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { ref, className: cn("border-b border-border transition-colors hover:bg-muted/50", className), ...props })
);
const TableHead = reactExports.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("th", { ref, className: cn("h-12 px-4 text-left align-middle font-medium text-muted-foreground", className), ...props })
);
const TableCell = reactExports.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("td", { ref, className: cn("p-4 align-middle", className), ...props })
);
...
const mode = "test";
const metrics = {"mrr":"—","balance":"—","pending":"—","customers":"—","failedPayments":"—"};
const churnRisk = [];
const refundQueue = [];
const receipts = [];
const initialData = {
...
function RevenueOps() {
  const [data] = reactExports.useState(
    initialData
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold tracking-tight", children: "Stripe Revenue Ops" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Live Stripe metrics, churn risk, and refund execution with receipts." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: data.mode === "live" ? "destructive" : "secondary", children: [
          "Stripe: ",
          data.mode === "live" ? "LIVE" : "TEST"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: "Connect Stripe to populate" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-5 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "MRR", value: data.metrics.mrr, unit: "$" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Balance", value: data.metrics.balance, unit: "$" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Pending", value: data.metrics.pending }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Customers", value: data.metrics.customers }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Failed payments", value: data.metrics.failedPayments })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Churn Risk This Month" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: churn.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No flagged customers yet. Once Stripe and your support inbox are connected, customers with 2+ support contacts, failed payments, or spend drops will surface here with audit evidence." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "MRR" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Signals" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Evidence" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: churn.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium", children: c.customer ?? "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: c.email ?? "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: c.mrr ?? "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: (c.signals ?? []).map((s, j) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: s }, j)) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "max-w-[260px] truncate text-xs text-muted-foreground", children: (c.evidence ?? []).join(", ") || "—" })
        ] }, c.id ?? i)) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Refund Execution" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: queue.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No refunds pending. Tell me which churn-risk customers to refund and I'll preview totals and wait for explicit confirmation before running." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Customer" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: queue.map((r, i) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: r.amount ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "max-w-[200px] truncate", children: r.reason ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: REFUND_VARIANT[status] ?? "outline", children: status }) })
            ] }, r.id ?? i);
          }) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Refund Receipts" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: receipts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No refunds executed yet. Every refund logs a receipt here with the Stripe refund id, mode, approver, and timestamp." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Refund" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Customer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Amount" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Mode" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "When" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: receipts.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-xs", children: r.refundId ?? "—" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                ...
                children: r.mode ?? "test"
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs text-muted-foreground", children: r.timestamp ?? "—" })
          ] }, r.id ?? i)) })
        ] }) })
      ] })
    ] })
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RevenueOps, {}) });
}
