...
const metrics$1 = {"open":"—","resolved":"—","responseTime":"—","csat":"—"};
const initialData$1 = {
  metrics: metrics$1,
};
...
function TicketQueue() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold tracking-tight", children: "Ticket Queue" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: "Connect ticketing tool" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Open", value: data.metrics.open }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Resolved (7d)", value: data.metrics.resolved }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Avg Response", value: data.metrics.responseTime }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "CSAT", value: data.metrics.csat })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Tickets by Priority" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", children: "P0 Critical" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Immediate alert + escalation" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "default", children: "P1 High" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Alert within 15 minutes" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: "P2 Medium" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Included in daily digest" })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Getting Started" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: `Say "Connect Zendesk" or "Connect Linear" — I'll pull tickets, auto-triage, and build SLA tracking.` }) })
    ] })
  ] });
}

const metrics = {"active":"0","mttr":"—","total":"0"};
const initialData = {
  metrics,
};
...
function IncidentTracker() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold tracking-tight", children: "Incident Tracker" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: "No active incidents" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Active Incidents", value: data.metrics.active }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Avg MTTR", value: data.metrics.mttr }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Incidents (30d)", value: data.metrics.total })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Incident History" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Incidents will be logged here with timelines, affected services, and resolution details." }) })
    ] })
  ] });
}

function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "ticket_queue", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "ticket_queue", children: "Ticket Queue" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "incident_tracker", children: "Incident Tracker" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "ticket_queue", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TicketQueue, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "incident_tracker", children: /* @__PURE__ */ jsxRuntimeExports.jsx(IncidentTracker, {}) })
  ] }) });
}
