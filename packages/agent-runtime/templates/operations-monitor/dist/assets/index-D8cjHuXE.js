...
const metrics$1 = {"endpoints":"0","uptime":"—","latency":"—","incidents":"0"};
const initialData$1 = {
  metrics: metrics$1,
};
...
function HealthDashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold tracking-tight", children: "Health Dashboard" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: "No endpoints configured" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Endpoints", value: data.metrics.endpoints }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Uptime", value: data.metrics.uptime }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Avg Latency", value: data.metrics.latency, unit: "ms" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Incidents (24h)", value: data.metrics.incidents })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Service Status" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: "●" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "API Server" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Not configured" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: "●" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Database" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Not configured" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: "●" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "CDN / Frontend" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Not configured" })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: `Share your API health check URLs and I'll start monitoring every 5 minutes. Say "Connect Sentry" for error tracking.` }) })
    ] })
  ] });
}

const metrics = {"alertsToday":"0","unresolved":"0","keywords":"0"};
const initialData = {
  metrics,
};
...
function AlertFeed() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold tracking-tight", children: "Alert Feed" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: "No alerts yet" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Alerts Today", value: data.metrics.alertsToday }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Unresolved", value: data.metrics.unresolved }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { label: "Keywords Watched", value: data.metrics.keywords })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Recent Alerts" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Health check failures, Slack keyword matches, and escalations will be logged here chronologically." }) })
    ] })
  ] });
}

function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "health_dashboard", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "health_dashboard", children: "Health Dashboard" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "alert_feed", children: "Alert Feed" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "health_dashboard", children: /* @__PURE__ */ jsxRuntimeExports.jsx(HealthDashboard, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "alert_feed", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AlertFeed, {}) })
  ] }) });
}
