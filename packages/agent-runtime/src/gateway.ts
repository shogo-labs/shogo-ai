...
**The more detail you include in the prompt, the better the canvas_agent will build.** Don't just say "build a dashboard" — specify the components, data, and layout.
