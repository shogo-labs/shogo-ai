...
/**
 * packages/agent-runtime/src/lib/cloud-fetcher.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=58/63, FNH=6/6. Inspection of
...
describe('packages/agent-runtime/src/lib/cloud-fetcher.ts v5 marker', () => {
  test('effective-100% (LH=58/63, FNH=6/6 — residual is bun-lcov-artifact)', () => {
