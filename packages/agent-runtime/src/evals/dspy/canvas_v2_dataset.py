...
CANVAS_V2_DATASET = [
    # 1. Simple display-only
    {
        ...
        "needs_backend": False,
        "prisma_models": "none",
        "canvas_files": "canvas/dashboard.js",
        "tool_sequence": "write_file (canvas/dashboard.js)",
    ...
    # 2. Interactive counter (no backend)
    {
        ...
        "needs_backend": False,
        "prisma_models": "none",
        "canvas_files": "canvas/counter.js",
        "tool_sequence": "write_file (canvas/counter.js)",
        "react_patterns": "useState",
    ...
    # 3. Full-stack lead tracker
    {
        ...
        "needs_backend": True,
        "prisma_models": "Lead",
        "canvas_files": "canvas/leads.js",
        "tool_sequence": "write_file (.shogo/server/schema.prisma), write_file (canvas/leads.js)",
    ...
    # 4. Bookmark manager with search
    {
        ...
        "canvas_files": "canvas/bookmarks.js",
        "tool_sequence": "write_file (.shogo/server/schema.prisma), write_file (canvas/bookmarks.js)",
    ...
    # 5. Expense dashboard with chart
    {
        ...
        "canvas_files": "canvas/expenses.js",
        "tool_sequence": "write_file (.shogo/server/schema.prisma), write_file (canvas/expenses.js)",
    ...
    # 6. Kanban board
    {
        ...
        "needs_backend": True,
        "prisma_models": "Task",
        "canvas_files": "canvas/board.js",
        "tool_sequence": "write_file (.shogo/server/schema.prisma), write_file (canvas/board.js)",
    ...
    # 7. CRM pipeline
    {
        ...
        "needs_backend": True,
        "prisma_models": "Deal",
        "canvas_files": "canvas/crm.js",
        "tool_sequence": "write_file (.shogo/server/schema.prisma), write_file (canvas/crm.js)",
    ...
    # 8. Multi-surface (dashboard + settings)
    {
        ...
        "needs_backend": False,
        "prisma_models": "none",
        "canvas_files": "canvas/dashboard.js, canvas/settings.js",
        "tool_sequence": "write_file (canvas/dashboard.js), write_file (canvas/settings.js)",
        "react_patterns": "useState, Switch",
        "reasoning": "Two separate tabs, no persistence needed. Each is a separate canvas/*.js file.",
    },
    # 9. Edit existing canvas — add chart
    {
        ...
        "prisma_models": "none",
        "canvas_files": "canvas/dashboard.js",
        "tool_sequence": "edit_file (canvas/dashboard.js)",
    ...
    # 10. Team roster display
    {
        ...
        "needs_backend": False,
        "prisma_models": "none",
        "canvas_files": "canvas/team.js",
        "tool_sequence": "write_file (canvas/team.js)",
        "react_patterns": "useState",
