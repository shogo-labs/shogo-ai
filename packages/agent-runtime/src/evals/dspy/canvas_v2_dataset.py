...
CANVAS_V2_DATASET = [
    ...
    # 3. Full-stack lead tracker
    {
        ...
        "tool_sequence": "write_file (.shogo/server/schema.prisma), write_file (canvas/leads.ts)",
    ...
    # 4. Bookmark manager with search
    {
        ...
        "tool_sequence": "write_file (.shogo/server/schema.prisma), write_file (canvas/bookmarks.ts)",
    ...
    # 5. Expense dashboard with chart
    {
        ...
        "tool_sequence": "write_file (.shogo/server/schema.prisma), write_file (canvas/expenses.ts)",
    ...
    # 6. Kanban board
    {
        ...
        "tool_sequence": "write_file (.shogo/server/schema.prisma), write_file (canvas/board.ts)",
    ...
    # 7. CRM pipeline
    {
        ...
        "tool_sequence": "write_file (.shogo/server/schema.prisma), write_file (canvas/crm.ts)",
