...
export const TEMPLATE_EVALS: AgentEval[] = [
  ...
  // ── Template Behavior: Incident Commander follows priority rules ────
  {
    ...
    validationCriteria: [
      ...
      {
        id: 'uses-canvas',
        description: 'Agent builds an incident canvas or status page',
        points: 25,
        phase: 'execution',
        validate: (r) => usedTool(r, 'canvas_create') || usedTool(r, 'canvas_update'),
      },
  ...
  // ── Template Behavior: Personal Assistant habit tracking ────────────
  {
    ...
    validationCriteria: [
      ...
      {
        id: 'creates-canvas',
        description: 'Agent builds a canvas for the habit board',
        points: 25,
        phase: 'execution',
