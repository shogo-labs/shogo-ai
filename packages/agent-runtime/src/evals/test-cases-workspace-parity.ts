    ...
    validationCriteria: [
      {
        ...
        points: 5,
        phase: 'execution',
        validate: (r) => r.runtimeChecks?.viteBuildReadiness?.ready === true,
      },
      {
        id: 'has-package-json',
        ...
        points: 1,
        phase: 'execution',
        validate: (r) => r.runtimeChecks?.viteBuildReadiness?.hasPackageJson === true,
      },
      {
        id: 'has-vite-config',
        ...
        points: 1,
        phase: 'execution',
        validate: (r) => r.runtimeChecks?.viteBuildReadiness?.hasViteConfig === true,
      },
      {
        id: 'has-app-tsx',
        ...
        points: 1,
        phase: 'execution',
        validate: (r) => r.runtimeChecks?.viteBuildReadiness?.hasAppTsx === true,
      },
      {
        id: 'has-vite-bin',
        ...
        points: 2,
        phase: 'execution',
        validate: (r) => r.runtimeChecks?.viteBuildReadiness?.hasViteBin === true,
      },
      {
