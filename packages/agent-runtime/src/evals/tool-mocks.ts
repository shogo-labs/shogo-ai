...
// ---------------------------------------------------------------------------
// Fixture: Skill search — mixed results (managed integration + skills)
// Agent searches for capabilities and sees both integration and skill results.
// ---------------------------------------------------------------------------
...
export const SKILL_SEARCH_MIXED_MOCKS: ToolMockMap = {
  tool_search: {
    ...
    default: { query: 'unknown', results: [], message: 'No tools or skills found.' },
  },
}
...
export const SKILL_INSTALL_MOCKS: ToolMockMap = {
  ...
  tool_install: {
    ...
    default: { error: 'Unknown tool or skill' },
  },
  read_file: {
    type: 'pattern',
    paramKeys: ['path'],
...
// ---------------------------------------------------------------------------
// Fixture: Skill lifecycle — search → install → read → execute
// Full end-to-end: agent finds a skill, installs it, reads instructions,
// and follows them using web tool.
// ---------------------------------------------------------------------------
...
export const SKILL_LIFECYCLE_MOCKS: ToolMockMap = {
  ...
  web: {
    ...
    patterns: [
      {
        match: { url: 'example' },
        response: { content: '<html><body><h1>OK</h1><p>Service healthy. Response time: 45ms.</p></body></html>', status: 200, bytes: 80, url: 'https://example.com' },
      },
    ],
    default: { content: '<html><body><h1>OK</h1><p>All systems operational. Status: 200 OK.</p></body></html>', status: 200, bytes: 80, url: 'https://api.example.com/health' },
  },
  memory_read: {
    type: 'static',
