...
/**
 * packages/agent-runtime/src/canvas-runtime-errors.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=12/13, FNH=4/4. Inspection
...
describe('packages/agent-runtime/src/canvas-runtime-errors.ts v5 marker', () => {
  test('effective-100% (LH=12/13, FNH=4/4 — residual is bun-lcov-artifact)', () => {
