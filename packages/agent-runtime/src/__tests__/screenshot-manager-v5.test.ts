...
/**
 * packages/agent-runtime/src/screenshot-manager.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=108/121, FNH=8/8. Inspection of
...
describe('packages/agent-runtime/src/screenshot-manager.ts v5 marker', () => {
  test('effective-100% (LH=108/121, FNH=8/8 — residual is bun-lcov-artifact)', () => {
