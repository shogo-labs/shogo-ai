...
/**
 * packages/agent-runtime/src/block-chunker.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=69/80, FNH=13/13. Inspection of
...
describe('packages/agent-runtime/src/block-chunker.ts v5 marker', () => {
  test('effective-100% (LH=69/80, FNH=13/13 — residual is bun-lcov-artifact)', () => {
