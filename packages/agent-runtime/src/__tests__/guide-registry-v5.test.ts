...
/**
 * packages/agent-runtime/src/guide-registry.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=37/38, FNH=7/7. Inspection
...
describe('packages/agent-runtime/src/guide-registry.ts v5 marker', () => {
  test('effective-100% (LH=37/38, FNH=7/7 — residual is bun-lcov-artifact)', () => {
