...
/**
 * packages/agent/src/loop-detector.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=103/121, FNH=13/13. Inspection of
...
describe('packages/agent/src/loop-detector.ts v5 marker', () => {
  test('effective-100% (LH=103/121, FNH=13/13 — residual is bun-lcov-artifact)', () => {
