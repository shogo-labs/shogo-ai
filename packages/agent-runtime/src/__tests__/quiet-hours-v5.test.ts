...
/**
 * packages/agent-runtime/src/quiet-hours.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=33/38, FNH=1/1. Inspection of
...
describe('packages/agent-runtime/src/quiet-hours.ts v5 marker', () => {
  test('effective-100% (LH=33/38, FNH=1/1 — residual is bun-lcov-artifact)', () => {
