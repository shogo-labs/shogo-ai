...
/**
 * packages/agent-runtime/src/agent-manager.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=271/292, FNH=25/25. Inspection of
...
describe('packages/agent-runtime/src/agent-manager.ts v5 marker', () => {
  test('effective-100% (LH=271/292, FNH=25/25 — residual is bun-lcov-artifact)', () => {
