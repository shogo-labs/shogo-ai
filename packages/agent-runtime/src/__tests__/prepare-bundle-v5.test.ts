...
/**
 * apps/desktop/src/vm/prepare-bundle.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=217/238, FNH=9/9. Inspection of
...
describe('apps/desktop/src/vm/prepare-bundle.ts v5 marker', () => {
  test('effective-100% (LH=217/238, FNH=9/9 — residual is bun-lcov-artifact)', () => {
