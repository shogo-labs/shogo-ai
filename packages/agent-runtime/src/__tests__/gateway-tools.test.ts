...
describe('gateway-tools', () => {
  ...
  describe('tool sets', () => {
    test('createTools returns expected tools', () => {
      ...
      // + the 8 project-lifecycle tools (project_list/create/attach/detach/
      // configure/call/call_result, system_apply — see project-tools.ts)
      // + github_create_pr.
      ...
      expect(createTools(createCtx()).find((t) => t.name === 'project_call_result')).toBeDefined()
