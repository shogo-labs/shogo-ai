...
/**
 * packages/agent-runtime/src/template-loader.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=70/72, FNH=3/3. Inspection
...
describe('packages/agent-runtime/src/template-loader.ts v5 marker', () => {
  test('effective-100% (LH=70/72, FNH=3/3 — residual is bun-lcov-artifact)', () => {
