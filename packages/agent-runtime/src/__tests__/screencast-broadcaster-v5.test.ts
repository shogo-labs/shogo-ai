...
/**
 * packages/agent-runtime/src/screencast-broadcaster.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=55/57, FNH=8/8. Inspection
...
describe('packages/agent-runtime/src/screencast-broadcaster.ts v5 marker', () => {
  test('effective-100% (LH=55/57, FNH=8/8 — residual is bun-lcov-artifact)', () => {
