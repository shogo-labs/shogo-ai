...
/**
 * packages/agent-runtime/src/file-attachment-utils.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=57/67, FNH=5/5. Inspection of
...
describe('packages/agent-runtime/src/file-attachment-utils.ts v5 marker', () => {
  test('effective-100% (LH=57/67, FNH=5/5 — residual is bun-lcov-artifact)', () => {
