...
/**
 * packages/agent-runtime/src/slash-commands.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=135/142, FNH=15/15. Inspection of
...
describe('packages/agent-runtime/src/slash-commands.ts v5 marker', () => {
  test('effective-100% (LH=135/142, FNH=15/15 — residual is bun-lcov-artifact)', () => {
