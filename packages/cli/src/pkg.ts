...
export class PlatformPackageManager {
  ...
  execToolSync(
    ...
    return nodeExecSync(cmd, {
      ...
      // (see shellOpt() doc).
      shell: this.shellOpt() as string | undefined,
      encoding: 'utf-8',
