...
/**
 * packages/sdk/src/errors.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=48/52, FNH=9/9. Inspection
...
describe('packages/sdk/src/errors.ts v5 marker', () => {
  test('effective-100% (LH=48/52, FNH=9/9 — residual is bun-lcov-artifact)', () => {
