...
/**
 * packages/sdk/src/memory/drivers/bun.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=39/42, FNH=6/6. Inspection
...
describe('packages/sdk/src/memory/drivers/bun.ts v5 marker', () => {
  test('effective-100% (LH=39/42, FNH=6/6 — residual is bun-lcov-artifact)', () => {
