...
export default defineConfig({
  ...
  external: [
    ...
    '@shogo-ai/core/macos-junk',
    '@shogo-ai/core/tech-stack-registry',
    '@shogo-ai/core/file-types',
    '@shogo-ai/agent',
    ...
    '@shogo-ai/agent/ai-client',
    '@shogo-ai/agent/ai-proxy',
    '@shogo-ai/db',
    '@shogo-ai/email',
