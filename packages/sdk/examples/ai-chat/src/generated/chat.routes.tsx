...
import type { ChatHooks } from "./chat.hooks"
...
/**
 * Set hooks for Chat routes
 */
export function setChatHooks(h: ChatHooks) {
  hooks = h
}
...
export function createChatRoutes(): Hono {
  ...
  router.post("/", async (c) => {
    try {
      ...
      const item = await prisma.chat.create({
        data: body,
      })
  ...
  router.patch("/:id", async (c) => {
    try {
      ...
      const item = await prisma.chat.update({
        where: { id },
        data: body,
      })
