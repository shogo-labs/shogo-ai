...
import type { MessageHooks } from "./message.hooks"

// Prisma client instance (injected)
let prisma: PrismaClient | null = null

let hooks: MessageHooks = {}
...
/**
 * Set hooks for Message routes
 */
export function setMessageHooks(h: MessageHooks) {
  hooks = h
}
...
/**
 * Create Message CRUD routes
 */
export function createMessageRoutes(): Hono {
