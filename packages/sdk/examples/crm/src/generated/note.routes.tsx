...
import type { NoteHooks } from "./note.hooks"
...
/**
 * Set hooks for Note routes
 */
export function setNoteHooks(h: NoteHooks) {
  hooks = h
}
...
/**
 * Create Note CRUD routes
 */
export function createNoteRoutes(): Hono {
