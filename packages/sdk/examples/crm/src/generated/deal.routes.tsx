...
import type { DealHooks } from "./deal.hooks"
...
/**
 * Set hooks for Deal routes
 */
export function setDealHooks(h: DealHooks) {
  hooks = h
}
...
/**
 * Create Deal CRUD routes
 */
export function createDealRoutes(): Hono {
  ...
  router.post("/", async (c) => {
    try {
      ...
      const item = await prisma.deal.create({
        data: body,
      })
  ...
  router.patch("/:id", async (c) => {
    try {
      ...
      const item = await prisma.deal.update({
        where: { id },
        data: body,
      })
