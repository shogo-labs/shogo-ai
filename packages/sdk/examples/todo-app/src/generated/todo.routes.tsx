...
import type { TodoHooks } from "./todo.hooks"
...
/**
 * Set hooks for Todo routes
 */
export function setTodoHooks(h: TodoHooks) {
  hooks = h
}
 ...
 */
export function createTodoRoutes(): Hono {
