...
import type { FieldHooks } from "./field.hooks"
...
/**
 * Set hooks for Field routes
 */
export function setFieldHooks(h: FieldHooks) {
  hooks = h
}
...
/**
 * Create Field CRUD routes
 */
export function createFieldRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      const item = await prisma.field.findUnique({
        where: { id },
      })
      ...
      console.error("[Field] Get error:", error)
