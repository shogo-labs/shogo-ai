/**
 * Auto-generated Response Routes
 *
...
import type { ResponseHooks } from "./response.hooks"
...
/**
 * Set hooks for Response routes
 */
export function setResponseHooks(h: ResponseHooks) {
  hooks = h
}
...
/**
 * Create Response CRUD routes
 */
export function createResponseRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return c.json({ error: { code: "not_found", message: "Response not found" } }, 404)
      }
  ...
  router.post("/", async (c) => {
    try {
      ...
      const item = await prisma.response.create({
        data: body,
      })
  ...
  router.patch("/:id", async (c) => {
    try {
      ...
      const item = await prisma.response.update({
        where: { id },
        data: body,
      })
