...
/**
 * Create Form CRUD routes
 */
export function createFormRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      const item = await prisma.form.findUnique({
        where: { id },
      })
