...
import type { BoardHooks } from "./board.hooks"
...
/**
 * Set hooks for Board routes
 */
export function setBoardHooks(h: BoardHooks) {
  hooks = h
}
...
/**
 * Create Board CRUD routes
 */
export function createBoardRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return c.json({ error: { code: "not_found", message: "Board not found" } }, 404)
      }
