...
import type { CardHooks } from "./card.hooks"
...
/**
 * Set hooks for Card routes
 */
export function setCardHooks(h: CardHooks) {
  hooks = h
}
...
/**
 * Create Card CRUD routes
 */
export function createCardRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      const item = await prisma.card.findUnique({
        where: { id },
      })
  ...
  router.patch("/:id", async (c) => {
    try {
      ...
      const item = await prisma.card.update({
        where: { id },
        data: body,
      })
