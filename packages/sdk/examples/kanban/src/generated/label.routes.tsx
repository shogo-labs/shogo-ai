...
import type { LabelHooks } from "./label.hooks"
...
/**
 * Set hooks for Label routes
 */
export function setLabelHooks(h: LabelHooks) {
  hooks = h
}
 ...
 */
export function createLabelRoutes(): Hono {
  ...
  router.get("/", async (c) => {
    try {
      ...
      console.error("[Label] List error:", error)
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      const item = await prisma.label.findUnique({
        where: { id },
      })
  ...
  router.post("/", async (c) => {
    try {
      ...
      const item = await prisma.label.create({
        data: body,
      })
  ...
  router.patch("/:id", async (c) => {
    try {
      ...
      const item = await prisma.label.update({
        where: { id },
        data: body,
      })
