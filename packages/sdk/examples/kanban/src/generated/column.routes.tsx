...
import type { ColumnHooks } from "./column.hooks"

// Prisma client instance (injected)
let prisma: PrismaClient | null = null

let hooks: ColumnHooks = {}
...
/**
 * Set hooks for Column routes
 */
export function setColumnHooks(h: ColumnHooks) {
  hooks = h
}
...
/**
 * Create Column CRUD routes
 */
export function createColumnRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return c.json({ error: { code: "not_found", message: "Column not found" } }, 404)
      }

      return c.json({ ok: true, data: item })
    } catch (error: any) {
      console.error("[Column] Get error:", error)
