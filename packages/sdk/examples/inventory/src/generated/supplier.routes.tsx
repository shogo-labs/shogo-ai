...
/**
 * Auto-generated Supplier Routes
 *
...
import type { SupplierHooks } from "./supplier.hooks"

// Prisma client instance (injected)
let prisma: PrismaClient | null = null

let hooks: SupplierHooks = {}
...
/**
 * Set hooks for Supplier routes
 */
export function setSupplierHooks(h: SupplierHooks) {
  hooks = h
}
 ...
 */
export function createSupplierRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return c.json({ error: { code: "not_found", message: "Supplier not found" } }, 404)
      }
