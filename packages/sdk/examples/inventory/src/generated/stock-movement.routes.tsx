/**
 * Auto-generated StockMovement Routes
 *
...
import type { StockMovementHooks } from "./stock-movement.hooks"

// Prisma client instance (injected)
let prisma: PrismaClient | null = null

let hooks: StockMovementHooks = {}
...
/**
 * Set hooks for StockMovement routes
 */
export function setStockMovementHooks(h: StockMovementHooks) {
  hooks = h
}
...
/**
 * Create StockMovement CRUD routes
 */
export function createStockMovementRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return c.json({ error: { code: "not_found", message: "StockMovement not found" } }, 404)
      }

      return c.json({ ok: true, data: item })
    } catch (error: any) {
      console.error("[StockMovement] Get error:", error)
  ...
  router.patch("/:id", async (c) => {
    try {
      ...
      const item = await prisma.stockMovement.update({
        where: { id },
        data: body,
      })
  ...
  router.delete("/:id", async (c) => {
    try {
      ...
      console.error("[StockMovement] Delete error:", error)
