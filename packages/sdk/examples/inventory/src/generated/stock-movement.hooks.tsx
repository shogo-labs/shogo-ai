...
/**
 * Hooks for StockMovement routes
 */
export interface StockMovementHooks {
  /**
...
/**
 * Default StockMovement hooks (customize as needed)
 */
export const stockMovementHooks: StockMovementHooks = {
