...
export const LoginPage = observer(function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)' }}>
      <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-md text-center">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">💰 Expense Tracker</h1>
        <p className="text-gray-500 mb-6">Track your income and expenses.</p>
        ...
        <p className="mt-6 text-sm text-gray-500">
          ...
          <button onClick={() => { setMode(mode === 'signin' ? 'signup' : 'signin'); auth.clearError() }} className="text-green-600 font-medium" style={{ background: 'none', border: 'none', cursor: 'pointer' }}>
