...
/**
 * packages/shared-runtime/src/diagnostics-build-buffer.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=49/51, FNH=4/4. Inspection
...
describe('packages/shared-runtime/src/diagnostics-build-buffer.ts v5 marker', () => {
  test('effective-100% (LH=49/51, FNH=4/4 — residual is bun-lcov-artifact)', () => {
