...
/**
 * Auto-generated UsageEvent Collection
 *
...
import { UsageEventModel, type IUsageEvent, type IUsageEventSnapshotIn } from "./usage-event.model"
 ...
 */
export const UsageEventCollection = types
  .model("UsageEventCollection", {
    items: types.map(UsageEventModel),
  ...
  .views(self => ({
    ...
    /** Get item by ID */
    get(id: string): IUsageEvent | undefined {
    ...
    filter(predicate: (item: IUsageEvent) => boolean): IUsageEvent[] {
      return this.all.filter(predicate)
    },

    /** Find first item matching predicate */
    find(predicate: (item: IUsageEvent) => boolean): IUsageEvent | undefined {
  ...
  .actions(self => {
    ...
    return {
      ...
      addItem(item: IUsageEventSnapshotIn) {
        self.items.put(item)
      },
       ...
       */
      create: flow(function* (input: Partial<IUsageEventSnapshotIn>) {
       ...
       */
      update: flow(function* (id: string, changes: Partial<IUsageEventSnapshotIn>) {
        const existing = self.items.get(id)
        if (!existing) {
...
const relationFields = ["workspace","project"]
...
// Type exports
export type IUsageEventCollection = Instance<typeof UsageEventCollection>
