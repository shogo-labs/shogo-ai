...
/**
 * Auto-generated StarredProject Collection
 *
...
import { StarredProjectModel, type IStarredProject, type IStarredProjectSnapshotIn } from "./starred-project.model"
 ...
 */
export const StarredProjectCollection = types
  .model("StarredProjectCollection", {
    items: types.map(StarredProjectModel),
  ...
  .views(self => ({
    ...
    get all(): IStarredProject[] {
      return Array.from(self.items.values())
    },

    /** Get item by ID */
    get(id: string): IStarredProject | undefined {
    ...
    filter(predicate: (item: IStarredProject) => boolean): IStarredProject[] {
      return this.all.filter(predicate)
    },

    /** Find first item matching predicate */
    find(predicate: (item: IStarredProject) => boolean): IStarredProject | undefined {
  ...
  .actions(self => {
    ...
    return {
      ...
      addItem(item: IStarredProjectSnapshotIn) {
        self.items.put(item)
      },
       ...
       */
      create: flow(function* (input: Partial<IStarredProjectSnapshotIn>) {
       ...
       */
      update: flow(function* (id: string, changes: Partial<IStarredProjectSnapshotIn>) {
        const existing = self.items.get(id)
        if (!existing) {
...
// Type exports
export type IStarredProjectCollection = Instance<typeof StarredProjectCollection>
