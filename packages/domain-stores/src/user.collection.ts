...
/**
 * Auto-generated User Collection
 *
...
import { UserModel, type IUser, type IUserSnapshotIn } from "./user.model"
 ...
 */
export const UserCollection = types
  ...
  .views(self => ({
    ...
    filter(predicate: (item: IUser) => boolean): IUser[] {
      return this.all.filter(predicate)
    },

    /** Find first item matching predicate */
    find(predicate: (item: IUser) => boolean): IUser | undefined {
  ...
  .actions(self => {
    ...
    return {
       ...
       */
      create: flow(function* (input: Partial<IUserSnapshotIn>) {
       ...
       */
      update: flow(function* (id: string, changes: Partial<IUserSnapshotIn>) {
        const existing = self.items.get(id)
        if (!existing) {
...
// Type exports
export type IUserCollection = Instance<typeof UserCollection>
