...
export const InvitationModel = types
  .model("Invitation", {
    ...
    status: types.optional(types.enumeration("InvitationStatus", ["pending", "accepted", "declined", "expired", "cancelled"]), "pending"),
    emailStatus: types.optional(types.enumeration("EmailStatus", ["not_sent", "sent", "failed"]), "not_sent"),
