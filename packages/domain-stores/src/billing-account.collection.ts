...
/**
 * Auto-generated BillingAccount Collection
 *
...
import { BillingAccountModel, type IBillingAccount, type IBillingAccountSnapshotIn } from "./billing-account.model"
 ...
 */
export const BillingAccountCollection = types
  .model("BillingAccountCollection", {
    items: types.map(BillingAccountModel),
  ...
  .views(self => ({
    ...
    get all(): IBillingAccount[] {
      return Array.from(self.items.values())
    },

    /** Get item by ID */
    get(id: string): IBillingAccount | undefined {
    ...
    filter(predicate: (item: IBillingAccount) => boolean): IBillingAccount[] {
      return this.all.filter(predicate)
    },

    /** Find first item matching predicate */
    find(predicate: (item: IBillingAccount) => boolean): IBillingAccount | undefined {
  ...
  .actions(self => {
    ...
    return {
      ...
      addItem(item: IBillingAccountSnapshotIn) {
        self.items.put(item)
      },
       ...
       */
      create: flow(function* (input: Partial<IBillingAccountSnapshotIn>) {
       ...
       */
      update: flow(function* (id: string, changes: Partial<IBillingAccountSnapshotIn>) {
        const existing = self.items.get(id)
        if (!existing) {
...
// Type exports
export type IBillingAccountCollection = Instance<typeof BillingAccountCollection>
