...
/**
 * Auto-generated ProjectFolder Collection
 *
...
import { ProjectFolderModel, type IProjectFolder, type IProjectFolderSnapshotIn } from "./project-folder.model"
import type { ISDKEnvironment } from "@shogo-ai/sdk"

// ============================================================================
// ProjectFolder Collection
// ============================================================================

const ENDPOINT = "/api/project-folders"

/**
 * ProjectFolder Collection Model
 *
 * Features:
 ...
 */
export const ProjectFolderCollection = types
  .model("ProjectFolderCollection", {
    items: types.map(ProjectFolderModel),
  ...
  .views(self => ({
    ...
    get all(): IProjectFolder[] {
      return Array.from(self.items.values())
    },

    /** Get item by ID */
    get(id: string): IProjectFolder | undefined {
    ...
    filter(predicate: (item: IProjectFolder) => boolean): IProjectFolder[] {
      return this.all.filter(predicate)
    },

    /** Find first item matching predicate */
    find(predicate: (item: IProjectFolder) => boolean): IProjectFolder | undefined {
  ...
  .actions(self => {
    ...
    return {
      ...
      addItem(item: IProjectFolderSnapshotIn) {
        self.items.put(item)
      },
       ...
       */
      create: flow(function* (input: Partial<IProjectFolderSnapshotIn>) {
       ...
       */
      update: flow(function* (id: string, changes: Partial<IProjectFolderSnapshotIn>) {
        const existing = self.items.get(id)
        if (!existing) {
...
function transformForMST(obj: any): any {
  ...
  const dateFields = ["addedAt","lastOpenedAt"]
...
// Type exports
export type IProjectFolderCollection = Instance<typeof ProjectFolderCollection>
