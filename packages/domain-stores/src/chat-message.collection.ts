...
/**
 * Auto-generated ChatMessage Collection
 *
 ...
 */
export const ChatMessageCollection = types
  .model("ChatMessageCollection", {
    items: types.map(ChatMessageModel),
  ...
  .views(self => ({
    ...
    get all(): IChatMessage[] {
      return Array.from(self.items.values())
    },

    /** Get item by ID */
    get(id: string): IChatMessage | undefined {
    ...
    filter(predicate: (item: IChatMessage) => boolean): IChatMessage[] {
      return this.all.filter(predicate)
    },

    /** Find first item matching predicate */
    find(predicate: (item: IChatMessage) => boolean): IChatMessage | undefined {
  ...
  .actions(self => {
    ...
    return {
      ...
      addItem(item: IChatMessageSnapshotIn) {
        self.items.put(item)
      },
       ...
       */
      create: flow(function* (input: Partial<IChatMessageSnapshotIn>) {
       ...
       */
      update: flow(function* (id: string, changes: Partial<IChatMessageSnapshotIn>) {
        const existing = self.items.get(id)
        if (!existing) {
...
// Type exports
export type IChatMessageCollection = Instance<typeof ChatMessageCollection>
