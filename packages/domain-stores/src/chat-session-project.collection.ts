...
/**
 * Auto-generated ChatSessionProject Collection
 *
...
import { ChatSessionProjectModel, type IChatSessionProject, type IChatSessionProjectSnapshotIn } from "./chat-session-project.model"
import type { ISDKEnvironment } from "@shogo-ai/sdk"

// ============================================================================
// ChatSessionProject Collection
// ============================================================================

const ENDPOINT = "/api/chat-session-projects"

/**
 * ChatSessionProject Collection Model
 *
 * Features:
 ...
 */
export const ChatSessionProjectCollection = types
  .model("ChatSessionProjectCollection", {
    items: types.map(ChatSessionProjectModel),
  ...
  .views(self => ({
    ...
    get all(): IChatSessionProject[] {
      return Array.from(self.items.values())
    },

    /** Get item by ID */
    get(id: string): IChatSessionProject | undefined {
    ...
    get modelName(): string {
      return "ChatSessionProject"
    },

    /** Filter items by predicate */
    filter(predicate: (item: IChatSessionProject) => boolean): IChatSessionProject[] {
      return this.all.filter(predicate)
    },

    /** Find first item matching predicate */
    find(predicate: (item: IChatSessionProject) => boolean): IChatSessionProject | undefined {
  ...
  .actions(self => {
    ...
    return {
      ...
      addItem(item: IChatSessionProjectSnapshotIn) {
        self.items.put(item)
      },
       ...
       */
      create: flow(function* (input: Partial<IChatSessionProjectSnapshotIn>) {
       ...
       */
      update: flow(function* (id: string, changes: Partial<IChatSessionProjectSnapshotIn>) {
        const existing = self.items.get(id)
        if (!existing) {
...
const relationFields = ["session","project"]
...
// Type exports
export type IChatSessionProjectCollection = Instance<typeof ChatSessionProjectCollection>
