...
/**
 * Auto-generated WorkspaceGrant Collection
 *
...
import { WorkspaceGrantModel, type IWorkspaceGrant, type IWorkspaceGrantSnapshotIn } from "./workspace-grant.model"
import type { ISDKEnvironment } from "@shogo-ai/sdk"

// ============================================================================
// WorkspaceGrant Collection
// ============================================================================

const ENDPOINT = "/api/workspace-grants"

/**
 * WorkspaceGrant Collection Model
 *
 * Features:
 ...
 */
export const WorkspaceGrantCollection = types
  .model("WorkspaceGrantCollection", {
    items: types.map(WorkspaceGrantModel),
  ...
  .views(self => ({
    ...
    get all(): IWorkspaceGrant[] {
      return Array.from(self.items.values())
    },

    /** Get item by ID */
    get(id: string): IWorkspaceGrant | undefined {
    ...
    filter(predicate: (item: IWorkspaceGrant) => boolean): IWorkspaceGrant[] {
      return this.all.filter(predicate)
    },

    /** Find first item matching predicate */
    find(predicate: (item: IWorkspaceGrant) => boolean): IWorkspaceGrant | undefined {
  ...
  .actions(self => {
    ...
    return {
      ...
      addItem(item: IWorkspaceGrantSnapshotIn) {
        self.items.put(item)
      },
       ...
       */
      create: flow(function* (input: Partial<IWorkspaceGrantSnapshotIn>) {
       ...
       */
      update: flow(function* (id: string, changes: Partial<IWorkspaceGrantSnapshotIn>) {
        const existing = self.items.get(id)
        if (!existing) {
...
function transformForMST(obj: any): any {
  ...
  const dateFields = ["startsAt","expiresAt","createdAt","updatedAt"]
...
// Type exports
export type IWorkspaceGrantCollection = Instance<typeof WorkspaceGrantCollection>
