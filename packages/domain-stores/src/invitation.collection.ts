...
/**
 * Auto-generated Invitation Collection
 *
...
import { InvitationModel, type IInvitation, type IInvitationSnapshotIn } from "./invitation.model"
 ...
 */
export const InvitationCollection = types
  .model("InvitationCollection", {
    items: types.map(InvitationModel),
  ...
  .views(self => ({
    ...
    /** Get item by ID */
    get(id: string): IInvitation | undefined {
    ...
    filter(predicate: (item: IInvitation) => boolean): IInvitation[] {
      return this.all.filter(predicate)
    },

    /** Find first item matching predicate */
    find(predicate: (item: IInvitation) => boolean): IInvitation | undefined {
  ...
  .actions(self => {
    ...
    return {
      ...
      addItem(item: IInvitationSnapshotIn) {
        self.items.put(item)
      },
       ...
       */
      create: flow(function* (input: Partial<IInvitationSnapshotIn>) {
       ...
       */
      update: flow(function* (id: string, changes: Partial<IInvitationSnapshotIn>) {
        const existing = self.items.get(id)
        if (!existing) {
...
function transformForMST(obj: any): any {
  ...
  const dateFields = ["emailSentAt","expiresAt","createdAt","updatedAt"]
...
// Type exports
export type IInvitationCollection = Instance<typeof InvitationCollection>
