...
export const UsageWalletModel = types
  .model("UsageWallet", {
    ...
    fiveHourWindowStart: types.optional(types.number, 0),
    fiveHourUsedUsd: types.optional(types.number, 0),
    weeklyWindowStart: types.optional(types.number, 0),
    weeklyUsedUsd: types.optional(types.number, 0),
