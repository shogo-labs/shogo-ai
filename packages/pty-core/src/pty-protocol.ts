 ...
 *     0x04 ACK     payload: u32 seq (BE) for flow control
 *
...
export type ClientFrame =
  ...
  | { type: typeof ClientFrameType.ACK; seq: number }
  ...
  switch (type) {
    ...
    case ClientFrameType.ACK: {
      ...
      const seq =
        ...
        ((payload[2] << 8) >>> 0) +
        (payload[3] >>> 0)
      return { type: ClientFrameType.ACK, seq }
    }
    default:
      return null
  }
