 ...
 * replicate out to EU/India like any other workspace column.
 *
 * Assignment
 * ----------
 ...
 * the workspace id, evenly across the three regions. This is an initial
...
// Deterministic, even 3-way split keyed on the workspace id. `bit(32)::bigint`
// is unsigned (0..2^32-1) so the modulo is always 0/1/2. Mirrors the CASE used
