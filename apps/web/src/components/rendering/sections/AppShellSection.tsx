...
export const AppShellSection = observer(function AppShellSection({
  ...
  const initialActiveTab = appBarConfig?.navLinks?.find((link: { active?: boolean }) => link.active)?.id as string | null ?? null
          ...
          >
            <AppBarSection
              ...
              config={{
                ...
                navLinks: appBarConfig?.navLinks?.map((link: { id: string; active?: boolean }) => ({
                  ...link,
