...
export const ProjectModel = types
  .model("Project", {
    ...
    tier: types.enumeration("ProjectTier", [/* enum values */]),
    status: types.enumeration("ProjectStatus", [/* enum values */]),
    schemas: types.string,
    ...
    accessLevel: types.enumeration("AccessLevel", [/* enum values */]),
