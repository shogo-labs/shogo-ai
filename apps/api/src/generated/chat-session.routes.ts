...
import type { ChatSessionHooks } from "./chat-session.hooks"

// Prisma client instance (injected)
let prisma: PrismaClient | null = null

let hooks: ChatSessionHooks = {}
...
/**
 * Set hooks for ChatSession routes
 */
export function setChatSessionHooks(h: ChatSessionHooks) {
  hooks = h
}
...
/**
 * Create ChatSession CRUD routes
 */
export function createChatSessionRoutes(): Hono {
