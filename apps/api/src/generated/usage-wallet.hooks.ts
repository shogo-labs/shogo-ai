...
/**
 * Hooks for UsageWallet routes
 */
export interface UsageWalletHooks {
  /**
...
/**
 * Default UsageWallet hooks (customize as needed)
 */
export const usageWalletHooks: UsageWalletHooks = {
