...
import type { FolderHooks } from "./folder.hooks"

// Prisma client instance (injected)
let prisma: PrismaClient | null = null

let hooks: FolderHooks = {}
...
/**
 * Set hooks for Folder routes
 */
export function setFolderHooks(h: FolderHooks) {
  hooks = h
}
