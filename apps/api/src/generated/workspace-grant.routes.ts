...
/**
 * Auto-generated WorkspaceGrant Routes
 *
...
import type { WorkspaceGrantHooks } from "./workspace-grant.hooks"

// Prisma client instance (injected)
let prisma: PrismaClient | null = null

let hooks: WorkspaceGrantHooks = {}
...
/**
 * Set hooks for WorkspaceGrant routes
 */
export function setWorkspaceGrantHooks(h: WorkspaceGrantHooks) {
  hooks = h
}
...
/**
 * Create WorkspaceGrant CRUD routes
 */
export function createWorkspaceGrantRoutes(): Hono {
  ...
  router.get("/", async (c) => {
    try {
      ...
      console.error("[WorkspaceGrant] List error:", error)
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      console.error("[WorkspaceGrant] Get error:", error)
  ...
  router.post("/", async (c) => {
    try {
      ...
      const item = await prisma.workspaceGrant.create({
        data: body,
      })
      ...
      console.error("[WorkspaceGrant] Create error:", error)
  ...
  router.patch("/:id", async (c) => {
    try {
      ...
      console.error("[WorkspaceGrant] Update error:", error)
  ...
  router.delete("/:id", async (c) => {
    try {
      ...
      await prisma.workspaceGrant.delete({
        where: { id },
      })
      ...
      console.error("[WorkspaceGrant] Delete error:", error)
