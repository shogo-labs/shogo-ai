...
/**
 * Auto-generated UsageWallet Routes
 *
...
import type { UsageWalletHooks } from "./usage-wallet.hooks"

// Prisma client instance (injected)
let prisma: PrismaClient | null = null

let hooks: UsageWalletHooks = {}
...
/**
 * Set hooks for UsageWallet routes
 */
export function setUsageWalletHooks(h: UsageWalletHooks) {
  hooks = h
}
...
/**
 * Create UsageWallet CRUD routes
 */
export function createUsageWalletRoutes(): Hono {
  ...
  router.get("/", async (c) => {
    try {
      ...
      console.error("[UsageWallet] List error:", error)
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      console.error("[UsageWallet] Get error:", error)
  ...
  router.post("/", async (c) => {
    try {
      ...
      const item = await prisma.usageWallet.create({
        data: body,
      })
      ...
      console.error("[UsageWallet] Create error:", error)
  ...
  router.patch("/:id", async (c) => {
    try {
      ...
      console.error("[UsageWallet] Update error:", error)
  ...
  router.delete("/:id", async (c) => {
    try {
      ...
      await prisma.usageWallet.delete({
        where: { id },
      })
      ...
      console.error("[UsageWallet] Delete error:", error)
