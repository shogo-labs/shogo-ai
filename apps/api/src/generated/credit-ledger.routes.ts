...
/**
 * Set hooks for CreditLedger routes
 */
export function setCreditLedgerHooks(h: CreditLedgerHooks) {
  hooks = h
}
...
/**
 * Create CreditLedger CRUD routes
 */
export function createCreditLedgerRoutes(): Hono {
