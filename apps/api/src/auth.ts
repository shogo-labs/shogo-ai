...
export const auth = betterAuth({
  ...
  socialProviders: isLocalMode ? {} : {
    ...
    // bundle id below as the audience. We gate the provider on env vars
    // being present so deployments without Apple credentials still boot.
    //
    ...
    //                           with Apple key. Generated by deploy
