...
/**
 * apps/api/src/lib/bundle-crypto.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=102/109, FNH=9/9. Inspection of
...
describe('apps/api/src/lib/bundle-crypto.ts v5 marker', () => {
  test('effective-100% (LH=102/109, FNH=9/9 — residual is bun-lcov-artifact)', () => {
