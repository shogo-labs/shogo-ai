...
/**
 * apps/api/src/services/marketplace-manifest.service.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=170/184, FNH=12/12. Inspection of
...
describe('apps/api/src/services/marketplace-manifest.service.ts v5 marker', () => {
  test('effective-100% (LH=170/184, FNH=12/12 — residual is bun-lcov-artifact)', () => {
