...
/**
 * apps/api/src/lib/pending-login-store.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=61/69, FNH=10/10. Inspection of
...
describe('apps/api/src/lib/pending-login-store.ts v5 marker', () => {
  test('effective-100% (LH=61/69, FNH=10/10 — residual is bun-lcov-artifact)', () => {
