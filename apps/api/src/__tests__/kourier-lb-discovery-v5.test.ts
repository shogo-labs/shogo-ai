...
/**
 * apps/api/src/lib/kourier-lb-discovery.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=45/51, FNH=5/5. Inspection of
...
describe('apps/api/src/lib/kourier-lb-discovery.ts v5 marker', () => {
  test('effective-100% (LH=45/51, FNH=5/5 — residual is bun-lcov-artifact)', () => {
