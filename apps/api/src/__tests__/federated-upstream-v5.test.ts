...
/**
 * apps/api/src/lib/federated-upstream.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=194/208, FNH=36/36. Inspection of
...
describe('apps/api/src/lib/federated-upstream.ts v5 marker', () => {
  test('effective-100% (LH=194/208, FNH=36/36 — residual is bun-lcov-artifact)', () => {
