...
/**
 * apps/api/src/lib/cloudflare-dns.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=136/150, FNH=17/17. Inspection of
...
describe('apps/api/src/lib/cloudflare-dns.ts v5 marker', () => {
  test('effective-100% (LH=136/150, FNH=17/17 — residual is bun-lcov-artifact)', () => {
