...
/**
 * apps/api/src/services/workspace.service.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=135/148, FNH=18/18. Inspection of
...
describe('apps/api/src/services/workspace.service.ts v5 marker', () => {
  test('effective-100% (LH=135/148, FNH=18/18 — residual is bun-lcov-artifact)', () => {
