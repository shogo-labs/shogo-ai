...
/**
 * apps/api/src/services/diarization.service.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=182/201, FNH=19/19. Inspection of
...
describe('apps/api/src/services/diarization.service.ts v5 marker', () => {
  test('effective-100% (LH=182/201, FNH=19/19 — residual is bun-lcov-artifact)', () => {
