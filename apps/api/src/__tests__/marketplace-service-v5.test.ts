...
/**
 * apps/api/src/services/marketplace.service.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=175/179, FNH=25/25. Inspection
...
describe('apps/api/src/services/marketplace.service.ts v5 marker', () => {
  test('effective-100% (LH=175/179, FNH=25/25 — residual is bun-lcov-artifact)', () => {
