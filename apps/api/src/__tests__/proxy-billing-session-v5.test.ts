...
/**
 * apps/api/src/lib/proxy-billing-session.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=195/225, FNH=13/13. Inspection of
...
describe('apps/api/src/lib/proxy-billing-session.ts v5 marker', () => {
  test('effective-100% (LH=195/225, FNH=13/13 — residual is bun-lcov-artifact)', () => {
