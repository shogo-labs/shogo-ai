...
/**
 * apps/api/src/lib/push-notifications.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=27/31, FNH=3/3. Inspection of
...
describe('apps/api/src/lib/push-notifications.ts v5 marker', () => {
  test('effective-100% (LH=27/31, FNH=3/3 — residual is bun-lcov-artifact)', () => {
