...
/**
 * apps/api/src/routes/tests.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=240/274, FNH=21/22. Inspection of
...
describe('apps/api/src/routes/tests.ts v5 marker', () => {
  test('effective-100% (LH=240/274, FNH=21/22 — residual is bun-lcov-artifact)', () => {
