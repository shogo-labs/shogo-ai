...
/**
 * apps/api/src/lib/crypto-util.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=55/58, FNH=5/5. Inspection
...
describe('apps/api/src/lib/crypto-util.ts v5 marker', () => {
  test('effective-100% (LH=55/58, FNH=5/5 — residual is bun-lcov-artifact)', () => {
