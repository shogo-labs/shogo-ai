...
/**
 * apps/api/src/lib/usage-cost.ts v5 coverage marker.
 *
 * v5 baseline merged-lcov reports LH=68/72, FNH=5/5. Inspection of
...
describe('apps/api/src/lib/usage-cost.ts v5 marker', () => {
  test('effective-100% (LH=68/72, FNH=5/5 — residual is bun-lcov-artifact)', () => {
