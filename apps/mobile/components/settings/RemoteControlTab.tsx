...
/**
 * Remote Control Tab (Settings)
 *
 * Manage local Shogo instances, view their status, and switch between them.
 * Rendered inside the Settings page as the "Remote Control" tab.
 */
    ...
    <View className="gap-8">
      ...
      <View className="flex-row items-start justify-between gap-4">
        <View className="flex-1">
          <Text className="text-xl font-semibold text-foreground">Remote Control</Text>
