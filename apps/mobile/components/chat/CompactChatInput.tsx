...
export const CompactChatInput = forwardRef<View, CompactChatInputProps>(
  function CompactChatInput(
    ...
    const interactionMode =
      controlledInteractionMode ?? internalInteractionMode;
      ...
      <View ref={ref} className={cn("w-full", className)}>
        <Animated.View
          ...
          className={cn(
            "relative",
            !useProminentComposer &&
              "overflow-hidden rounded-xl border bg-card border-border/60"
          )}
          style={
            useProminentComposer
              ? {
            ...
            {voiceInput.isRecording ? (
              ...
              >
                ...
                <Pressable
                  ...
                  className={cn(
                    ...
                    useProminentComposer || useCurrentNativeSizing
              ...
              >
                ...
                <ComposerSendButton
                  ...
                  fillColor={
                    useProminentComposer ? chatgptComposer.sendFill : undefined
                  }
                  iconColor={
                    useProminentComposer ? chatgptComposer.sendIcon : undefined
                  }
                />
                {!isLoading &&
                !(
