...
import {
  ...
  File, FileCode2, FilePlus, FileText, FolderKanban, FolderOpen, FolderPlus,
  ...
  Package, Palette, PanelLeft, PanelLeftClose, Paperclip, Pencil, Phone,
  Plane, Plus,
  RefreshCw, Rocket,
  Save, ScrollText, Search, Send, Server, Settings, Shield, Sparkles,
  Square, Star, StarOff, Sun,
